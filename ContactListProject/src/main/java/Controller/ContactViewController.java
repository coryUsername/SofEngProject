...
public class ContactViewController implements Initializable {
  ...
  /**
   * @brief Handles the deletion of the current contact.
   *
  ...
  /**
   * @brief Handles navigation back to the main view.
   *
  ...
  /**
   * @brief Sets the contact information in the labels from the given Contact object.
   *
  ...
  /**
   * @brief Handles modifying the current contact. Opens the contact form view and
