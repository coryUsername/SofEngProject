...
public class ContactFormViewController implements Initializable {
    ...
    /**
     * Returns to the main view. Does not save the changes.
     *
    ...
    /**
     * Handles the input in phone number fields, ensuring that only numeric
    ...
    /**
     * Handles the save operation for a contact. Creates a new contact or
    ...
    /**
     * Sets the contact fields in the view.
     *
     * @param contact The contact to be displayed.
