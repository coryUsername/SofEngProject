...
public class ContactList {
    ...
    /**
     * @details This is a linked list of contacts. Each contact is stored as a
     * Contact object.
     */
    ...
    public void addContact(Contact contact) throws IOException {
        if (contacts.size() < 10000) {
            ...
            throw new IOException("La rubrica è piena!"); // in inglese o ita?
        }
    }
     ...
     * @return A Contact object that matches the search query, or null if no
     * match is found.
     */
   ...
   * @return A list of contacts that match the filtering criterion.
     ...
     *
     * @param criteria The criterion by which to sort (e.g., by name, surname,
     * or company).
     */
    ...
    /**
     * Imports contacts into the contact list from a source (e.g., file,
     * database).
     *
